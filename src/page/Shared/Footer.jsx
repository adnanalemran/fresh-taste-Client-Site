  ...
  return (
    <div className="bg-gray-950">
      <footer className="footer p-10 text-base-content max-w-7xl mx-auto">
        <nav>
          <header className="footer-title">Services info</header>
          <Link to="/food-cook-agency" className="link link-hover">Food cook agency</Link>
          <Link to="/food-delivery-policy" className="link link-hover">Food delivery policy</Link>
        </nav>
        <nav>
